...
const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$module$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(SUPABASE_URL, SUPABASE_ANON_KEY, {
    auth: {
...
async function createSession(userId) {
    ...
    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('sessions').insert({
        id: token,
        user_id: userId,
...
async function getCurrentSession() {
    ...
    // Get session
    const { data: sessionRow, error: sessionError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('sessions').select('*').eq('id', token).gt('expires_at', nowSec).maybeSingle();
    if (sessionError) {
    ...
    // Get user data
    const { data: userRow, error: userError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('users').select('*').eq('id', sessionRow.user_id).maybeSingle();
...
async function invalidateSession() {
    ...
    const token = cookieStore.get(SESSION_COOKIE_NAME)?.value;
    if (token) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('sessions').delete().eq('id', token);
    }
    cookieStore.delete(SESSION_COOKIE_NAME);
}
async function cleanupExpiredSessions() {
    const nowSec = Math.floor(Date.now() / 1000);
    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('sessions').delete().lt('expires_at', nowSec);
}
async function signUp(email, password, name) {
    const normalizedEmail = email.toLowerCase().trim();
    const trimmedName = name.trim();
    // Check if user already exists
    const { data: existingUser, error: existingErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('users').select('id').eq('email', normalizedEmail).maybeSingle();
    if (existingErr) {
    ...
    const { data: insertedUser, error: insertErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('users').insert({
...
async function signIn(email, password) {
    const normalizedEmail = email.toLowerCase().trim();
    const { data: userRow, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].from('users').select('*').eq('email', normalizedEmail).maybeSingle();
    if (error) {
...
async function POST(request) {
    try {
        ...
        // Create user
        const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["signUp"])(email, password, name);
        // Create session
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSession"])(user.id);
        ...
        if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AuthError"]) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: error.message
            }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__92e53c87._.js.map